if(GSTIO_CDT_ROOT STREQUAL "" OR NOT GSTIO_CDT_ROOT)
   set(GSTIO_CDT_ROOT "@CDT_ROOT_DIR@")
endif()

list(APPEND CMAKE_MODULE_PATH ${GSTIO_CDT_ROOT}/lib/cmake/gstio.cdt)
if (NOT GSTIO_WASM_OLD_BEHAVIOR STREQUAL "Off")
    set(GSTIO_WASM_OLD_BEHAVIOR "On")
    include(GstioWasmToolchain)
endif()

include(GstioCDTMacros)
...
function(GSTIO_CHECK_VERSION output version hard_min soft_max hard_max) # optional 6th argument for error message
...
endfunction(GSTIO_CHECK_VERSION)
