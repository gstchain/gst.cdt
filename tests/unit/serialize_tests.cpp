...
struct D1 : public B {
   const int i{};
   GSTLIB_SERIALIZE_DERIVED( D1, B, (i) )
...
struct D2 : public D1 {
   ...
   GSTLIB_SERIALIZE_DERIVED( D2, D1, (v) )
...
// Definitions in `gstio.cdt/libraries/gstio/serialize.hpp`
GSTIO_TEST_BEGIN(serialize_test)
