...
using gstio::name;
using gstio::symbol;
using gstio::extended_symbol;
using gstio::asset;
using gstio::extended_asset;
...
// Definitions in `gstio.cdt/libraries/gstio/asset.hpp`
GSTIO_TEST_BEGIN(asset_type_test)
...
// Definitions in `gstio.cdt/libraries/gstio/asset.hpp`
GSTIO_TEST_BEGIN(extended_asset_type_test)
   static constexpr symbol sym_no_prec{"SYMBOLL",0};
   static constexpr symbol sym_prec{"SYMBOLL",63};

   static constexpr extended_symbol ext_sym_no_prec{sym_no_prec, name{"gstioaccountj"}};
   static constexpr extended_symbol ext_sym_prec{sym_prec, name{"gstioaccountj"}};
   ...
   CHECK_EQUAL( (extended_asset{{},ext_sym_no_prec}.contract), (name{"gstioaccountj"}) )

   //// extended_asset(asset, name)
   CHECK_EQUAL( (extended_asset{asset_no_prec, name{"gstioaccountj"}}.quantity), (asset{ 0LL, sym_no_prec}) )
   CHECK_EQUAL( (extended_asset{asset_no_prec, name{"gstioaccountj"}}.contract), (name{"gstioaccountj"}) )
   ...
   CHECK_ASSERT( "type mismatch", (
      [&]() {
         extended_asset{asset_no_prec, name{"gstioaccountj"}} + extended_asset{asset_no_prec, name{"jtnuoccaoisoe"}};
      })
   )
   ...
   CHECK_ASSERT( "type mismatch", (
      [&]() {
         temp += extended_asset{asset_no_prec, name{"gstioaccountj"}};
      })
   )
   ...
   // --------------------------------------------------------------------
   // friend bool operator!=(const extended_asset&, const extended_asset&)
   CHECK_EQUAL( (extended_asset{asset_no_prec, name{"gstioaccountj"}} != extended_asset{asset_no_prec, name{"jtnuoccaoisoe"}}), true )
   CHECK_EQUAL( (extended_asset{asset{1LL, sym_no_prec}, {}} != extended_asset{asset{-1LL, sym_no_prec}, {}}), true )
   CHECK_EQUAL( (extended_asset{asset{1LL, sym_no_prec}, {}} != extended_asset{asset{ 0LL, sym_no_prec}, name{"gstioaccountj"}}), true )
   ...
   CHECK_ASSERT( "type mismatch", (
      [&]() {
         bool b{extended_asset{{}, name{}} < extended_asset{{}, name{"gstioaccountj"}}};
         return b;
      })
   )
...
int main(int argc, char* argv[]) {
   ...
   GSTIO_TEST(asset_type_test);
   GSTIO_TEST(extended_asset_type_test);
   return has_failed();
}
