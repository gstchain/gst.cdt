...
// Definitions in `gstio.cdt/libraries/gstio/symbol.hpp`
GSTIO_TEST_BEGIN(symbol_code_type_test)
...
// Definitions in `gstio.cdt/libraries/gstio/symbol.hpp`
GSTIO_TEST_BEGIN(symbol_type_test)
...
// Definitions in `gstio.cdt/libraries/gstio/symbol.hpp`
GSTIO_TEST_BEGIN(extended_symbol_type_test)
...
int main(int argc, char* argv[]) {
   ...
   GSTIO_TEST(symbol_code_type_test);
   GSTIO_TEST(symbol_type_test);
   GSTIO_TEST(extended_symbol_type_test);
   return has_failed();
}
