...
#include <gstio/time.hpp>

using std::numeric_limits;

using gstio::days;
using gstio::hours;
using gstio::microseconds;
using gstio::milliseconds;
using gstio::minutes;
using gstio::seconds;
using gstio::time_point;
using gstio::time_point_sec;
...
// Definitions in `gstio.cdt/libraries/gstio/time.hpp`
GSTIO_TEST_BEGIN(microseconds_type_test)
...
// Definitions in `gstio.cdt/libraries/gstio/time.hpp`
GSTIO_TEST_BEGIN(time_point_type_test)
...
// Definitions in `gstio.cdt/libraries/gstio/time.hpp`
GSTIO_TEST_BEGIN(time_point_sec_type_test)
   static const microseconds ms0 { 0LL};
   static const microseconds ms1 { 1LL};
   static const microseconds msn1{-1LL};
   static const microseconds ms_min{i64min};
...
// Definitions in `gstio.cdt/libraries/gstio/time.hpp`
GSTIO_TEST_BEGIN(block_timestamp_type_test)
...
int main(int argc, char* argv[]) {
   ...
   GSTIO_TEST(microseconds_type_test);
   GSTIO_TEST(time_point_type_test);
   GSTIO_TEST(time_point_sec_type_test);
   GSTIO_TEST(block_timestamp_type_test);
   return has_failed();
}
