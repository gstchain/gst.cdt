...
CONTRACT multi_index_example : public contract {
   public:
      ...
      typedef gstio::multi_index<"testtaba"_n, test_table, gstio::indexed_by<"secid"_n, gstio::const_mem_fun<test_table, uint64_t, &test_table::by_secondary>>> test_tables;
