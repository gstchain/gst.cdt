### Usage
---
To manually compile the source code, use `gstio-cpp/gstio-cc` and `gstio-ld` as if it were __clang__ and __lld__. All the includes and options specific to GSTIO and CDT are baked in.

###$ gstio-cpp
---
```
USAGE: gstio-cpp [options] <input file> ...
