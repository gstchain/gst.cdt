...
#warning "<gstiolib/crypto.h> is deprecated use <gstio/crypto.h>. If you are using C++ the .h header files will be removed from inclusion entirely in v1.7.0"
 ...
 *  gstio::print("sha256 hash generated from data equals provided hash");
 *  @endcode
 */
 ...
 *  gstio::print("sha1 hash generated from data equals provided hash");
 *  @endcode
 */
__attribute__((gstio_wasm_import))
 ...
 *  gstio::print("sha512 hash generated from data equals provided hash");
 *  @endcode
 */
__attribute__((gstio_wasm_import))
 ...
 *  gstio::print("ripemod160 hash generated from data equals provided hash");
 *  @endcode
 */
__attribute__((gstio_wasm_import))
 ...
 *  gst_assert( calc_hash == hash, "invalid hash" );
 *  @endcode
 */
__attribute__((gstio_wasm_import))
 ...
 *  gstio::print("pub key matches the pub key generated from digest");
 *  @endcode
 */
__attribute__((gstio_wasm_import))
