...
#warning "<gstiolib/crypto.hpp> is deprecated use <gstio/crypto.hpp>"
...
namespace gstio {
   ...
   */
   ...
   struct public_key {
      ...
      GSTLIB_SERIALIZE( public_key, (type)(data) )
   };
   ...
   */
   ...
   struct signature {
      ...
      GSTLIB_SERIALIZE( signature, (type)(data) )
   };
