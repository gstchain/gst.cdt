...
#warning "<gstiolib/privileged.hpp> is deprecated use <gstio/privileged.hpp>"
namespace gstio {
   ...
   */
   ...
   struct blockchain_parameters {
      ...
      */
      ...
      GSTLIB_SERIALIZE( blockchain_parameters,
   ...
   */
   ...
   struct producer_key {
      ...
      GSTLIB_SERIALIZE( producer_key, (producer_name)(block_signing_key) )
   };
