...
namespace gstio {
    ...
    *  @ingroup core
    *  @brief Defines wrappers over gstio_assert
    */
    ...
    *  Example:
    *  @code
    *  gstio::check(a == b, "a does not equal b");
    *  @endcode
    */
   inline void check(bool pred, const char* msg) {
      if (!pred) {
         internal_use_do_not_use::gstio_assert(false, msg);
      }
   }
   ...
   inline void check(bool pred, const std::string& msg) {
      if (!pred) {
         internal_use_do_not_use::gstio_assert(false, msg.c_str());
      }
   }
    ...
    *  gstio::check(a == b, "a does not equal b", 18);
    *  @endcode
    */
   inline void check(bool pred, const char* msg, size_t n) {
      if (!pred) {
         internal_use_do_not_use::gstio_assert_message(false, msg, n);
      }
   }
    ...
    *  gstio::check(a == b, msg, 18);
    *  @endcode
    */
   inline void check(bool pred, const std::string& msg, size_t n) {
      if (!pred) {
         internal_use_do_not_use::gstio_assert_message(false, msg.c_str(), n);
      }
   }
   ...
   inline void check(bool pred, uint64_t code) {
      if (!pred) {
         internal_use_do_not_use::gstio_assert_code(false, code);
      }
   }
} // namespace gstio
