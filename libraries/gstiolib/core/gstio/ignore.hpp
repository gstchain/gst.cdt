...
namespace gstio {
   ...
   inline DataStream& operator<<(DataStream& ds, const ::gstio::ignore_wrapper<T>& val) {
     ds << val.value;
     return ds;
   }
    ...
    */
   template<typename DataStream, typename T>
   inline DataStream& operator<<(DataStream& ds, const ::gstio::ignore<T>& val) {
     return ds;
   }
    ...
    */
   template<typename DataStream, typename T>
   inline DataStream& operator>>(DataStream& ds, ::gstio::ignore<T>&) {
     return ds;
   }
}
