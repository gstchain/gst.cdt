...
namespace gstio {
   ...
   gstio::public_key recover_key( const gstio::checksum256& digest, const gstio::signature& sig ) {
      ...
      char sig_data[70];
      gstio::datastream<char*> sig_ds( sig_data, sizeof(sig_data) );
      ...
      gstio::datastream<char*> pubkey_ds( pubkey_data, pubkey_size );
      gstio::public_key pubkey;
      pubkey_ds >> pubkey;
      return pubkey;
   }
   ...
   void assert_recover_key( const gstio::checksum256& digest, const gstio::signature& sig, const gstio::public_key& pubkey ) {
      ...
      char pubkey_data[38];
      gstio::datastream<char*> pubkey_ds( pubkey_data, sizeof(pubkey_data) );
