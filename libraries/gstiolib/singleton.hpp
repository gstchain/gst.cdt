...
#warning "<gstiolib/singleton.hpp> is deprecated use <gstio/singleton.hpp>"
namespace  gstio {

   /**
    *  @defgroup singleton Singleton Table
    *  @ingroup contracts
    *  @brief Defines GSTIO Singleton Table used with %multiindex
    *  @{
    */
   ...
   class singleton
   {
      ...
      struct row {
         ...
         GSTLIB_SERIALIZE( row, (value) )
      };

      typedef gstio::multi_index<SingletonName, row> table;
      ...
      public:
         ...
         T get() {
            ...
            gstio::check( itr != _t.end(), "singleton does not exist" );
            return itr->value;
         }
