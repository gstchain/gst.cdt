...
#warning "<gstiolib/symbol.hpp> is deprecated use <gstio/symbol.hpp>"
namespace gstio {
   ...
   */
   ...
   public:
      ...
      */
      ...
      friend inline DataStream& operator<<(DataStream& ds, const gstio::symbol_code sym_code) {
      ...
      */
      template<typename DataStream>
      friend inline DataStream& operator>>(DataStream& ds, gstio::symbol_code& sym_code) {
         uint64_t raw = 0;
