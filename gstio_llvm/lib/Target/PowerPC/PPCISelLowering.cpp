 ...
 */
bool PPC::isVMRGGSThuffleMask(ShuffleVectorSDNode *N, bool CheckEven,
                              unsigned ShuffleKind, SelectionDAG &DAG) {
  if (DAG.getDataLayout().isLittleEndian()) {
...
SDValue PPCTargetLowering::LowerVECTOR_SHUFFLE(SDValue Op,
  ...
  if (V2.isUndef()) {
    if (PPC::isSplatShuffleMask(SVOp, 1) ||
        ...
        (Subtarget.hasP8Altivec() && (
         ...
         PPC::isVMRGGSThuffleMask(SVOp, true, 1, DAG) ||
         PPC::isVMRGGSThuffleMask(SVOp, false, 1, DAG)))) {
      return Op;
    }
  }
  ...
  if (PPC::isVPKUWUMShuffleMask(SVOp, ShuffleKind, DAG) ||
      ...
      (Subtarget.hasP8Altivec() && (
       ...
       PPC::isVMRGGSThuffleMask(SVOp, true, ShuffleKind, DAG) ||
       PPC::isVMRGGSThuffleMask(SVOp, false, ShuffleKind, DAG))))
    return Op;
