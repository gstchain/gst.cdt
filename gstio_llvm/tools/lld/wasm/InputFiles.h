...
public:
  ...
  std::string getGstioABI() const { return gstio_abi; }
  ArrayRef<StringRef> getGstioActions() const { return gstio_actions; }
  ArrayRef<StringRef> getGstioNotify() const { return gstio_notify; }
private:
  std::string gstio_abi;
  ArrayRef<StringRef> gstio_actions;
  ArrayRef<StringRef> gstio_notify;
