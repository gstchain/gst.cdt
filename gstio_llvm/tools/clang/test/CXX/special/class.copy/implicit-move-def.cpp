...
void move_VirtualWithEmptyBase(VirtualWithEmptyBase &x, VirtualWithEmptyBase &y) {
  // CHECK: call {{.*}} @_ZN20VirtualWithEmptyBaseaSGST_
...
// CHECK-ASSIGN: define linkonce_odr {{.*}} @_ZN1DaSGST_
// CHECK-ASSIGN: call {{.*}} @_ZN1CaSGST_
// CHECK-ASSIGN: call {{.*}} @_ZN1AaSGST_
// CHECK-ASSIGN: call {{.*}} @_ZN1BaSGST_
// array loop
// CHECK-ASSIGN: br i1
// CHECK-ASSIGN: call {{.*}} @_ZN1AaSGST_

// VirtualWithEmptyBase move assignment operatpr
// CHECK-ASSIGN: define linkonce_odr {{.*}} @_ZN20VirtualWithEmptyBaseaSGST_
// CHECK-ASSIGN: store
// CHECK-ASSIGN-NEXT: store
// CHECK-ASSIGN-NOT: call
// CHECK-ASSIGN: ret

// CHECK-ASSIGN: define linkonce_odr {{.*}} @_ZN1CaSGST_
// CHECK-ASSIGN: call {{.*}} @_ZN1AaSGST_

// move ctors

// CHECK-CTOR: define linkonce_odr {{.*}} @_ZN1HC2GST_
// CHECK-CTOR: call {{.*}} @_ZN1GC2GST_
// CHECK-CTOR: call {{.*}} @_ZN1FC1GST_
// CHECK-CTOR: call {{.*}} @_ZN1EC1GST_
// array loop
// CHECK-CTOR: call {{.*}} @_ZN1FC1GST_
// CHECK-CTOR: br i1

// CHECK-CTOR: define linkonce_odr {{.*}} @_ZN1GC2GST_
// CHECK-CTOR: call {{.*}} @_ZN1EC1GST_
