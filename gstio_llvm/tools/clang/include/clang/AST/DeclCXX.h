...
public:
  ...
  bool isGstioContract() const { return hasAttr<GstioContractAttr>(); }
  bool isGstioAction() const { return hasAttr<GstioActionAttr>(); }
  bool isGstioTable() const { return hasAttr<GstioTableAttr>(); }
  bool isGstioIgnore() const { return hasAttr<GstioIgnoreAttr>(); }
  bool hasGstioRicardian() const { return hasAttr<GstioRicardianAttr>(); }
  GstioActionAttr* getGstioActionAttr() const { return getAttr<GstioActionAttr>(); }
  GstioTableAttr*  getGstioTableAttr() const { return getAttr<GstioTableAttr>(); }
  GstioContractAttr*  getGstioContractAttr() const { return getAttr<GstioContractAttr>(); }
  GstioRicardianAttr*  getGstioRicardianAttr() const { return getAttr<GstioRicardianAttr>(); }
...
public:
  ...
  bool isGstioAction() const { return hasAttr<GstioActionAttr>(); }
  bool isGstioNotify() const { return hasAttr<GstioNotifyAttr>(); }
  bool isGstioContract() const { return hasAttr<GstioContractAttr>(); }
  bool hasGstioRicardian() const { return hasAttr<GstioRicardianAttr>(); }
  GstioActionAttr* getGstioActionAttr() const { return getAttr<GstioActionAttr>(); }
  GstioNotifyAttr* getGstioNotifyAttr() const { return getAttr<GstioNotifyAttr>(); }
  GstioContractAttr* getGstioContractAttr() const { return getAttr<GstioContractAttr>(); }
  GstioRicardianAttr* getGstioRicardianAttr() const { return getAttr<GstioRicardianAttr>(); }
