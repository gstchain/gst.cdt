...
public:
  ...
  bool isGstioWasmABI()const;
  std::string getWasmABI()const;
  bool isGstioWasmEntry()const;
  bool isGstioWasmImport()const;
  bool isGstioWasmAction()const;
  std::string getGstioWasmAction()const;
  bool isGstioWasmNotify()const;
  std::string getGstioWasmNotify()const;
