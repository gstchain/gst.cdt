...
static void handleGstioRicardianAttribute(Sema &S, Decl *D, const AttributeList &AL) {
  ...
  if (AL.isArgExpr(0) && AL.getArgAsExpr(0) &&
   ...
   D->addAttr(::new (S.Context)
                 GstioRicardianAttr(AL.getRange(), S.Context, Str,
                                AL.getAttributeSpellingListIndex()));
}

static void handleGstioNotifyAttribute(Sema &S, Decl *D, const AttributeList &AL) {
  // Handle the cases where the attribute has a text message.
  StringRef Str, Replacement;
  if (AL.isArgExpr(0) && AL.getArgAsExpr(0) &&
      !S.checkStringLiteralArgumentAttr(AL, 0, Str))
   ...
   D->addAttr(::new (S.Context)
                 GstioNotifyAttr(AL.getRange(), S.Context, Str,
                                AL.getAttributeSpellingListIndex()));
}

static void handleGstioContractAttribute(Sema &S, Decl *D, const AttributeList &AL) {
  // Handle the cases where the attribute has a text message.
  StringRef Str, Replacement;
  if (AL.isArgExpr(0) && AL.getArgAsExpr(0) &&
      !S.checkStringLiteralArgumentAttr(AL, 0, Str))
    return;
  D->addAttr(::new (S.Context)
                 GstioContractAttr(AL.getRange(), S.Context, Str,
                                AL.getAttributeSpellingListIndex()));
}

static void handleGstioABIAttribute(Sema &S, Decl *D, const AttributeList &AL) {
  // Handle the cases where the attribute has a text message.
  StringRef Str, Replacement;
  if (AL.isArgExpr(0) && AL.getArgAsExpr(0) &&
      !S.checkStringLiteralArgumentAttr(AL, 0, Str))
  ...
  D->addAttr(::new (S.Context)
                 GstioWasmABIAttr(AL.getRange(), S.Context, Str,
                                AL.getAttributeSpellingListIndex()));
}

static void handleGstioWasmActionAttribute(Sema &S, Decl *D, const AttributeList &AL) {
  // Handle the cases where the attribute has a text message.
  StringRef Str, Replacement;
  if (AL.isArgExpr(0) && AL.getArgAsExpr(0) &&
      !S.checkStringLiteralArgumentAttr(AL, 0, Str))
  ...
  D->addAttr(::new (S.Context)
                 GstioWasmActionAttr(AL.getRange(), S.Context, Str,
                                AL.getAttributeSpellingListIndex()));
}

static void handleGstioWasmNotifyAttribute(Sema &S, Decl *D, const AttributeList &AL) {
  // Handle the cases where the attribute has a text message.
  StringRef Str, Replacement;
  if (AL.isArgExpr(0) && AL.getArgAsExpr(0) &&
      !S.checkStringLiteralArgumentAttr(AL, 0, Str))
  ...
  D->addAttr(::new (S.Context)
                 GstioWasmNotifyAttr(AL.getRange(), S.Context, Str,
                                AL.getAttributeSpellingListIndex()));
}

static void handleGstioActionAttribute(Sema &S, Decl *D, const AttributeList &AL) {
  // Handle the cases where the attribute has a text message.
  StringRef Str, Replacement;
  if (AL.isArgExpr(0) && AL.getArgAsExpr(0) &&
      !S.checkStringLiteralArgumentAttr(AL, 0, Str))
  ...
  D->addAttr(::new (S.Context)
                 GstioActionAttr(AL.getRange(), S.Context, Str,
                                AL.getAttributeSpellingListIndex()));
}

static void handleGstioTableAttribute(Sema &S, Decl *D, const AttributeList &AL) {
  // Handle the cases where the attribute has a text message.
  StringRef Str, Replacement;
  if (AL.isArgExpr(0) && AL.getArgAsExpr(0) &&
      !S.checkStringLiteralArgumentAttr(AL, 0, Str))
  ...
  D->addAttr(::new (S.Context)
                 GstioTableAttr(AL.getRange(), S.Context, Str,
                                AL.getAttributeSpellingListIndex()));
}
...
static void ProcessDeclAttribute(Sema &S, Scope *scope, Decl *D,
  ...
  default:
    ...
    break;
  case AttributeList::AT_GstioWasmImport:
    handleSimpleAttribute<GstioWasmImportAttr>(S, D, AL);
    break;
  case AttributeList::AT_GstioWasmEntry:
    handleSimpleAttribute<GstioWasmEntryAttr>(S, D, AL);
    break;
  case AttributeList::AT_GstioIgnore:
    handleSimpleAttribute<GstioIgnoreAttr>(S, D, AL);
    break;
  case AttributeList::AT_GstioAction:
    handleGstioActionAttribute(S, D, AL);
    break;
  case AttributeList::AT_GstioTable:
    handleGstioTableAttribute(S, D, AL);
    break;
  case AttributeList::AT_GstioWasmABI:
    handleGstioABIAttribute(S, D, AL);
    break;
  case AttributeList::AT_GstioWasmAction:
    handleGstioWasmActionAttribute(S, D, AL);
    break;
  case AttributeList::AT_GstioWasmNotify:
    handleGstioWasmNotifyAttribute(S, D, AL);
    break;
  case AttributeList::AT_GstioContract:
    handleGstioContractAttribute(S, D, AL);
    break;
  case AttributeList::AT_GstioRicardian:
    handleGstioRicardianAttribute(S, D, AL);
    break;
  case AttributeList::AT_GstioNotify:
    handleGstioNotifyAttribute(S, D, AL);
    break;
