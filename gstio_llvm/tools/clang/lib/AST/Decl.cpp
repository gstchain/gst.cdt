...
bool RecordDecl::isGstioIgnore() const { return hasAttr<GstioIgnoreAttr>(); }
...
bool FunctionDecl::isGstioWasmABI()const { return hasAttr<GstioWasmABIAttr>(); }
std::string FunctionDecl::getWasmABI()const { return getAttr<GstioWasmABIAttr>()->getAbi(); }
bool FunctionDecl::isGstioWasmEntry()const { return hasAttr<GstioWasmEntryAttr>(); }
bool FunctionDecl::isGstioWasmImport()const { return hasAttr<GstioWasmImportAttr>(); }
bool FunctionDecl::isGstioWasmAction()const { return hasAttr<GstioWasmActionAttr>(); }
std::string FunctionDecl::getGstioWasmAction()const { return getAttr<GstioWasmActionAttr>()->getName(); }
bool FunctionDecl::isGstioWasmNotify()const { return hasAttr<GstioWasmNotifyAttr>(); }
std::string FunctionDecl::getGstioWasmNotify()const { return getAttr<GstioWasmNotifyAttr>()->getName(); }
