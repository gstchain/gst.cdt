...
mkdir -p ${PROJECT}/${VERSION}/opt/gstio_cdt/lib/cmake
...
echo "class GstioCdt < Formula

   homepage \"${URL}\"
   revision 0
   url \"https://github.com/gstio/gstio.cdt/archive/v${VERSION}.tar.gz\"
   version \"${VERSION}\"
   ...
   bottle do
      root_url \"https://github.com/gstio/gstio.cdt/releases/download/v${VERSION}\"
