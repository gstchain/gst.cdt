...
def main():
    if len(sys.argv) == 1:
        print('Please specify an operation of export or import: ./ricardgst.py <import|export>')
        sys.exit(1)

    if sys.argv[1] == 'import':
        if len(sys.argv) < 4:
            print('Please specify a source and destination abi:')
            print('Usage: ./ricardgst.py import /gst/contracts/contract/mycontract.abi /gst/contracts/contract/withricardian-mycontract.abi')
        ...
        if len(sys.argv) < 3:
            ...
            print('Usage: ./ricardgst.py export /gst/contracts/contract/mycontract.abi')
